defmodule Tasks.TimeBlocksTest do
  use Tasks.DataCase
  ...
  describe "time_blocks" do
    ...
    test "create_time_block/1 with valid data creates a time_block" do
      ...
      assert time_block.end == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
      assert time_block.start == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
    end
    ...
    test "update_time_block/2 with valid data updates the time_block" do
      ...
      assert time_block.end == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
      assert time_block.start == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
    end
